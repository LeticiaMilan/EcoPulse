...
func NewLatLngWorkGeocodingApi(Baseurl string, httpClient *http.Client) *LatLngWorkGeocodingAPI {
...
func (g *LatLngWorkGeocodingAPI) ReverseGeocoding(ctx context.Context, GeocodingInputParams *ports.GeocodingInputParams) (*http.Response, error) {
